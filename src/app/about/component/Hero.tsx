...
function Hero() {
  return (
    <main >
        ...
        <div className='w-[80%]'>
          <h1 className='text-[28px] font-[500] text-justify'>Our team of professionals are characterised by their scholastic background from reputable
             ...
             <div className='flex justify-between mt-6'>
              <div className='w-[45%]'>
                <p className='text-justify text-[16px] font-[400]'>M.A. Mahmud SAN & Co is a leading cross border law firm dedicated to providing tailored legal services, creating timely and efficient legal solutions. Our team of professionals are characterized by their scholastic background 
