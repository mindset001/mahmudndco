    ...
    return (
        <main className='z-0 w-ful flex justify-center items-center my-40'>
            <div className='w-[80%] flex justify-between'>
                <div className='w-[45%]'>
                    <div>
                        <h1 className='text-[20px] font-[600] capitalize'>AMINA1 T. ZUKOGI LL.B, BL, LL.M (NOTARY PUBLIC)</h1>
                        <h2 className='text-[20px] font-[600]'>HOD of IT/Research Department</h2>
