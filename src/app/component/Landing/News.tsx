        ...
        <main className='flex flex-col justify-center items-center mt-20'>
            <div className='w-[80%]  '>
                <div className='flex justify-between items-center border-b pb-6 border-[#000]'>
                    <h1 className='text-[#000] font-[600] text-[35px]'>Latest News</h1>
                    <button className='flex items-center gap-2'>
                        <p className='text-[14px] font-[700] text-[#000]'>Read More</p>
                        <div className='border border-[#000] rounded-[50px] h-[40px] w-[40px] flex justify-center items-center text-[#000]'>{'>'}</div>
                    </button>
                </div>


                <div className='grid grid-cols-2 mt-6 gap-10 justify-between'>
                    {data.map((item, i) => (
