        ...
        <main className='hero-two flex flex-col justify-center items-center'>
            <div className='w-[80%] my-20'>
                <div className='flex justify-between items-center border-b pb-4 border-[#FFF1C6]'>
                    <h1 className='text-[#CDA233] font-[600] text-[35px]'>Our Practice Areas</h1>
                    <button className='flex items-center gap-2'>
                        <p className='text-[14px] font-[700] text-[#FFFFFF]'>Read More</p>
                        <div className='border border-[#CDA233] rounded-[50px] h-[40px] w-[40px] flex justify-center items-center text-[#CDA233]'>{'>'}</div>
                    </button>
                </div>
                            ...
                            <div className='group flex gap-2'>
                               ...
                               <h4 className='text-[#FFF1C6] text-[14px] font-[400]'>{item.id}</h4>
                                <div>
                                    ...
                                    <p className='text-[#FFFFFF] text-[14px] font-[400] w-[401px] group-hover:text-[#fff]'>{item.description}</p>
                                </div>
                               </div>
                            </div>
